---
title: "Weaviate"
description: "Featureform supports [Weaviate](https://weaviate.io/) as a [Vector DB](/providers/vector-db)."
---

## Configuration

First we have to add a declarative Weaviate configuration in Python. The following example shows the required fields.
