...
You can also try local mode in this example [📔 Google Colab notebook 📔](https://colab.research.google.com/drive/1mlS10dPa32IiaLNpbHsqFcoeoyrAggTa?usp=sharing&utm%5Fsource=Featureform%5FDocs&utm%5Fmedium=EmbeddedLink&utm%5Fcampaign=NoAssociatedCampaign) here.
